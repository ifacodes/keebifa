...
#[proc_macro_error]
#[proc_macro]
pub fn alice_layout(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
...
// take non-matrix layout

// get each layer

// combine the streams of each row and shift everything around?

// un-combine in the matrix 13x5
